...
export const steps = [
  { n: 1, title: 'Acesse na Hora', text: 'Receba acesso imediato a toda a biblioteca assim que sua compra for confirmada.' },
  { n: 2, title: 'Escolha Qualquer Anime', text: 'Dragon Ball, Naruto, One Piece, Bleach, Attack on Titan, Kimetsu no Yaiba e mais de 100 animes de sucesso.' },
  { n: 3, title: 'Crie Produtos Profissionais', text: 'Use os designs em camisetas, canecas, moletons, bonés, adesivos e centenas de outros.' },
  { n: 4, title: 'Publique e Comece a Vender', text: 'Venda pelo Instagram, Mercado Livre, Shopify, WooCommerce ou WhatsApp.' },
];

export const comparisonBad = [
  'Artes soltas e desorganizadas',
  'Você perde tempo procurando o arquivo certo',
  'Designs genéricos que parecem iguais aos de todo mundo',
  'Sem mockups prontos para divulgar',
  'Sem direção de uso para camiseta, caneca e sublimação',
  'Compra uma vez e fica parado no tempo',
];

export const comparisonGood = [
  'Mais de 10.000 artes prontas e editáveis',
  'Organizadas por estilo, personagem, tema e tipo de produto',
  'Artes premium para camisetas, canecas e personalizados',
  'Mockups prontos para anunciar antes de produzir',
  'Arquivos editáveis para ajustar cores, frases e detalhes',
  'Ideal para sublimação, personalizados e produtos sob demanda',
];

export const audience = [
  { title: 'Se Você Trabalha com Camisetas', text: 'e quer ter artes prontas para aplicar em camisetas, canecas e personalizados sem perder horas criando do zero.' },
  { title: 'Você Quer Começar com Baixo Investimento', text: 'e vender usando mockups antes de produzir, fazendo a camisa apenas depois que o cliente comprar.' },
  { title: 'Você Tem Loja de Personalizados', text: 'e quer oferecer produtos geek, anime e streetwear para um público apaixonado e comprador.' },
  { title: 'Você Vende por Redes Sociais ou Marketplace', text: 'e precisa de modelos prontos para postar, testar e vender todos os dias no Instagram, WhatsApp ou marketplace.' },
  { title: 'Você Não É Designer', text: 'mas quer entregar artes com aparência profissional, organizadas e fáceis de editar.' },
  { title: 'Você Quer Vender para Fãs', text: 'porque fãs compram por emoção, coleção, identificação e vontade de mostrar o que amam.' },
];
...
export const faqs = [
  {
    q: 'O pack tem estampas de todos os animes famosos?',
    a: 'Sim! O pack conta com mais de 10.000 artes totalmente editáveis de todos os animes mais famosos e amados do mundo (como Dragon Ball, Naruto, One Piece, Demon Slayer, Jujutsu Kaisen, Bleach, Attack on Titan, My Hero Academia e muito mais), prontas para aplicar e personalizar do seu jeito.',
  },
  {
    q: 'Posso usar as estampas tanto em camisetas quanto em canecas?',
    a: 'Sim! As artes são enviadas em alta resolução (300 DPI) com fundo transparente em formatos adequados. Você pode dimensionar, posicionar e aplicar as artes em camisetas, canecas, moletons, bonés, quadros e qualquer outro material personalizado.',
  },
  {
    q: 'Recebo o material na hora?',
    a: 'Sim! Logo após a confirmação do pagamento, você recebe imediatamente um link de acesso no seu e-mail para fazer o download completo de todas as pastas categorizadas.',
  },
  {
    q: 'O material serve para DTF, sublimação, serigrafia e transfer?',
    a: 'Sim. Como os arquivos são disponibilizados em alta definição com transparência e em vetor/PNG de altíssima qualidade, são compatíveis com qualquer processo de personalização como DTF (Direct to Film), Sublimação, Silk Screen, Serigrafia, Transfer Laser e Direct-to-Garment (DTG).',
  },
  {
    q: 'Preciso saber mexer em programas complexos de design?',
    a: 'Não é necessário. O pack já entrega os arquivos prontos para aplicar. Basta importar a imagem no seu software de gabarito ou prensa (como Photoshop, Canva, Studio Silhouette) e mandar imprimir.',
  },
];
